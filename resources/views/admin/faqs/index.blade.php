            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden h-fit">
                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.faqs.import') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label
                                    ...
                                    <input type="file" name="keywords_file" class="hidden" accept=".csv,.txt"
                                        required />
                                </label>
                            </div>
                        </div>
                        ...
                        <button type="submit"
                            class="w-full bg-black text-white font-medium py-3 px-4 rounded-lg hover:bg-gray-800 transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black">
