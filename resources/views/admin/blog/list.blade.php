        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p class="text-[hsl(var(--muted-foreground))] mt-1">Overview of all published and draft articles.</p>
                </div>
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            ...
                                            @else
                                                <div class="flex items-center gap-1.5 text-[hsl(var(--secondary))]">
                                                    <span
                                                        class="w-2 h-2 rounded-full bg-[hsl(var(--secondary))]"></span>
                                                    Published
                                                </div>
                                            @endif
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="w-8 h-8 mx-auto text-[hsl(var(--muted-foreground))] mb-2"
                                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
